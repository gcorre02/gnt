...
namespace NinjaTrader.Strategy
{
    ...
    public class RSI_ret_v9_NotTue : Strategy
    {
        #region Variables
        ...
        private int profit = 70; // Default setting for Profit
        private int rSIPeriod = 37; // Default setting for RSIPeriod
		private int roundTickDist = 0;
		private int trailStopLoss = 1;
		private int turnTrailOn = 0;
		private int turnExitOn = 0;
		private int lastStopMin = 1;
		private int bidAsk = 3;
		private int priceDif = 0;
		private int isPositiveOn = 1; 
		private int rOCPeriod = 60;
