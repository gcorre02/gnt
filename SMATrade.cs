...
namespace NinjaTrader.Strategy
{
    ...
    public class SMATrade : Strategy
    {
        #region Variables
        // Wizard generated variables
        private double maxTime = 2.000; // Default setting for MaxTime
        ...
        private int sMAPeriod = 800; // Default setting for SMAPeriod
        ...
        {
            Add(SMA(SMAPeriod));
            SetTrailStop("", CalculationMode.Ticks, RollStop, false);
        ...
        protected override void OnBarUpdate()
        {
                ...
                && Close[0] <= crossingPrice-TicksBack*TickSize)
            {
                ...
                EnterLongLimit(DefaultQuantity, crossingPrice+SetLimitorStop*TickSize, "");
            }
        }
